    ...
    <div>
      ...
      <hr/>
        <div className="row">
         ...
         <h3>Currently</h3>
         <ul>
            <li>Developing a Showcase for p5.js, an open source creative computing platform @ <a href="https://medium.com/processing-foundation/announcing-processing-foundation-google-summer-of-code-2020-af39dbf41d25" target="_blank">Google Summer of Code</a></li>
