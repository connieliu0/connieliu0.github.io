      ...
      <div className="bodytext">
        ...
        <div className="projmargins">
          <ProjHead
            ...
            image="aux0.png"
            timeline="Fall 2019, 36 Hour Hackathon, won BigRed//Hacks Beginner's Prize"
            role="With"
            team="Angelina Saliling-Backend, Jonna Chen-Frontend"
        ...
        <h4>My Role</h4>
        <h2>Illustrating and Designing</h2>
        ...
        <h2 className="forty">Final Product</h2>
        ...
        <h2 className="forty">Reflection</h2>
        ...
        <Bottom
      nextproject="Habitat for Humanity"
      next="https://connieliu0.github.io/#/habitat"
      />
        </div>
